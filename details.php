        ...
        <div class="col-md-6 sinfos ">
            ...
            <div class="row ">
                <div class="col-md-6 btn_cat ">
                    <button id="addCart"><a class="text-center" href="./myCartP.php?id=<?php echo $rows['id'];?>&title=<?php echo $rows['title'];?>
                    &price=<?php echo $rows['price'];?>&userId=<?php echo $_COOKIE['id'] ?? 0?>&type=1">add to Shopping Cart</a></button>
                </div>
                <div class="col-md-6  btn_buy">
                    <button id="payM"><a href="./myCartP.php?id=<?php echo $rows['id'];?>&title=<?php echo $rows['title'];?>
                    &price=<?php echo $rows['price'];?>&userId=<?php echo $_COOKIE['id'] ?? 0?>&type=2" class="text-center">pay immediately</a></button>
                </div>
            </div>
        </div>
    </div>
